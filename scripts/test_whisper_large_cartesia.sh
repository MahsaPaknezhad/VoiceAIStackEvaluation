...
STT_CONFIG="evaluation_data/stt_configs/whisper_large_config.json"
TTS_CONFIG="evaluation_data/tts_configs/cartesia_config.json"
OUTPUT="evaluation_output/test_whisper_large_cartesia_results.json"
EVAL_OUTPUT="evaluation_output/test_whisper_large_cartesia_evaluation.json"
