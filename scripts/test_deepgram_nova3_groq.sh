...
TTS_CONFIG="evaluation_data/tts_configs/groq_config.json"
OUTPUT="evaluation_output/test_deepgram_nova3_groq_results.json"
EVAL_OUTPUT="evaluation_output/test_deepgram_nova3_groq_evaluation.json"
