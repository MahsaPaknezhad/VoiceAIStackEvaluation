...
STT_CONFIG="data/stt_bot_configs/deepgram_nova3_config.json"
TTS_CONFIG="data/tts_bot_configs/groq_config.json"
OUTPUT="output/test_deepgram_nova3_groq_results.json"
EVAL_OUTPUT="output/test_deepgram_nova3_groq_evaluation.json"
