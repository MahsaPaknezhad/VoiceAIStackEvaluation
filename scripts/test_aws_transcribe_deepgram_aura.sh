...
STT_CONFIG="evaluation_data/stt_configs/aws_transcribe_config.json"
TTS_CONFIG="evaluation_data/tts_configs/deepgram_aura_config.json"
OUTPUT="evaluation_output/test_transcribe_deepgram_aura_results.json"
EVAL_OUTPUT="evaluation_output/test_transcribe_deepgram_aura_evaluation.json"
