...
STT_CONFIG="data/stt_bot_configs/aws_transcribe_config.json"
TTS_CONFIG="data/tts_bot_configs/deepgram_aura_config.json"
OUTPUT="output/test_transcribe_deepgram_aura_results.json"
EVAL_OUTPUT="output/test_transcribe_deepgram_aura_evaluation.json"
