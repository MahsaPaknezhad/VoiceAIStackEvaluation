...
STT_CONFIG="evaluation_data/stt_configs/whisper_turbo_config.json"
TTS_CONFIG="evaluation_data/tts_configs/groq_config.json"
OUTPUT="evaluation_output/test_whisper_turbo_groq_results.json"
EVAL_OUTPUT="evaluation_output/test_whisper_turbo_groq_evaluation.json"
