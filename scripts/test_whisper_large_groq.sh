...
STT_CONFIG="data/stt_bot_configs/whisper_large_config.json"
TTS_CONFIG="data/tts_bot_configs/groq_config.json"
OUTPUT="output/test_whisper_large_groq_results.json"
EVAL_OUTPUT="output/test_whisper_large_groq_evaluation.json"
