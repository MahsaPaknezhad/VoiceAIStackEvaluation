...
# Run evaluation for AWS Transcribe (STT) + Cartesia (TTS)

set -e

echo "=================================="
echo "AWS Transcribe + Cartesia Evaluation"
echo "=================================="
...
OUTPUT="evaluation_output/small/aws_transcribe_cartesia_results.json"
EVAL_OUTPUT="evaluation_output/small/aws_transcribe_cartesia_evaluation.json"
