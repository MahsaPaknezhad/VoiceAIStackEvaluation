...
# Run evaluation for AWS Transcribe (STT) + Fish Audio (TTS)

set -e

echo "=================================="
echo "AWS Transcribe + Fish Audio Evaluation"
echo "=================================="
...
TTS_CONFIG="evaluation_data/tts_bot_configs/fish_audio_config.json"
OUTPUT="evaluation_output/small/aws_transcribe_fish_audio_results.json"
EVAL_OUTPUT="evaluation_output/small/aws_transcribe_fish_audio_evaluation.json"
