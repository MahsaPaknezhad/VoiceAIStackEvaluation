...
# Run evaluation for OpenAI Whisper API (STT) + OpenAI TTS (TTS)

set -e

echo "=================================="
echo "OpenAI Whisper API + OpenAI TTS Evaluation"
echo "=================================="
...
TTS_CONFIG="evaluation_data/tts_bot_configs/openai_tts_config.json"
OUTPUT="evaluation_output/small/openai_whisper_openai_tts_results.json"
EVAL_OUTPUT="evaluation_output/small/openai_whisper_openai_tts_evaluation.json"
