...
# Run evaluation for AWS Transcribe (STT) + Rime (TTS)

set -e

echo "=================================="
echo "AWS Transcribe + Rime Evaluation"
echo "=================================="
...
TTS_CONFIG="evaluation_data/tts_bot_configs/rime_config.json"
OUTPUT="evaluation_output/small/aws_transcribe_rime_results.json"
EVAL_OUTPUT="evaluation_output/small/aws_transcribe_rime_evaluation.json"
