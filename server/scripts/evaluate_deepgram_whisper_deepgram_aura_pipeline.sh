...
# Run evaluation for Deepgram Whisper Cloud (STT) + Deepgram Aura (TTS)

set -e

echo "=================================="
echo "Deepgram Whisper Cloud + Deepgram Aura Evaluation"
echo "=================================="
...
STT_CONFIG="evaluation_data/stt_bot_configs/deepgram_whisper_config.json"
TTS_CONFIG="evaluation_data/tts_bot_configs/deepgram_aura_config.json"
OUTPUT="evaluation_output/small/deepgram_whisper_deepgram_aura_results.json"
EVAL_OUTPUT="evaluation_output/small/deepgram_whisper_deepgram_aura_evaluation.json"

echo "STT: Deepgram Whisper Cloud"
