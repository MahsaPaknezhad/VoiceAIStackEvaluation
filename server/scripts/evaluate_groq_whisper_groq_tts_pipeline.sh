...
# Run evaluation for Groq Whisper (STT) + Groq TTS (TTS)

set -e

echo "=================================="
echo "Groq Whisper + Groq TTS Evaluation"
echo "=================================="
...
STT_CONFIG="evaluation_data/stt_bot_configs/groq_whisper_config.json"
TTS_CONFIG="evaluation_data/tts_bot_configs/groq_tts_config.json"
OUTPUT="evaluation_output/small/groq_whisper_groq_tts_results.json"
EVAL_OUTPUT="evaluation_output/small/groq_whisper_groq_tts_evaluation.json"
