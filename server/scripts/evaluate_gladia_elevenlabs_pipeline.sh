...
# Run evaluation for Gladia (STT) + ElevenLabs (TTS)

set -e

echo "=================================="
echo "Gladia + ElevenLabs Evaluation"
echo "=================================="
...
STT_CONFIG="evaluation_data/stt_bot_configs/gladia_config.json"
TTS_CONFIG="evaluation_data/tts_bot_configs/elevenlabs_config.json"
OUTPUT="evaluation_output/small/gladia_elevenlabs_results.json"
EVAL_OUTPUT="evaluation_output/small/gladia_elevenlabs_evaluation.json"
