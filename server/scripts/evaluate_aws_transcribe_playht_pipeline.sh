...
# Run evaluation for AWS Transcribe (STT) + PlayHT (TTS)

set -e

echo "=================================="
echo "AWS Transcribe + PlayHT Evaluation"
echo "=================================="
...
TTS_CONFIG="evaluation_data/tts_bot_configs/playht_config.json"
OUTPUT="evaluation_output/small/aws_transcribe_playht_results.json"
EVAL_OUTPUT="evaluation_output/small/aws_transcribe_playht_evaluation.json"
