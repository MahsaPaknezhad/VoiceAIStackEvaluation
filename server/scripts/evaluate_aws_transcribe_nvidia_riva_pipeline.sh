...
# Run evaluation for AWS Transcribe (STT) + NVIDIA Riva (TTS)

set -e

echo "=================================="
echo "AWS Transcribe + NVIDIA Riva Evaluation"
echo "=================================="
...
TTS_CONFIG="evaluation_data/tts_bot_configs/nvidia_riva_config.json"
OUTPUT="evaluation_output/small/aws_transcribe_nvidia_riva_results.json"
EVAL_OUTPUT="evaluation_output/small/aws_transcribe_nvidia_riva_evaluation.json"

echo "STT: AWS Transcribe"
echo "TTS: NVIDIA Riva"
echo ""
