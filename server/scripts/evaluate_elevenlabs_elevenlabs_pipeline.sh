...
# Run evaluation for ElevenLabs (STT) + ElevenLabs (TTS)

set -e

echo "=================================="
echo "ElevenLabs + ElevenLabs Evaluation"
echo "=================================="
...
STT_CONFIG="evaluation_data/stt_bot_configs/elevenlabs_config.json"
TTS_CONFIG="evaluation_data/tts_bot_configs/elevenlabs_config.json"
OUTPUT="evaluation_output/small/elevenlabs_elevenlabs_results.json"
EVAL_OUTPUT="evaluation_output/small/elevenlabs_elevenlabs_evaluation.json"
