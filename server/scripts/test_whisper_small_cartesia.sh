...
STT_CONFIG="evaluation_data/stt_bot_configs/whisper_small_config.json"
TTS_CONFIG="evaluation_data/tts_bot_configs/cartesia_config.json"
OUTPUT="evaluation_output/test_whisper_small_cartesia_results.json"
EVAL_OUTPUT="evaluation_output/test_whisper_small_cartesia_evaluation.json"
