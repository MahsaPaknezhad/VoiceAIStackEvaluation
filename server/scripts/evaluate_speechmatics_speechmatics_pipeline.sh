...
# Run evaluation for Speechmatics (STT) + Speechmatics TTS (TTS)

set -e

echo "=================================="
echo "Speechmatics + Speechmatics TTS Evaluation"
echo "=================================="
...
STT_CONFIG="evaluation_data/stt_bot_configs/speechmatics_config.json"
TTS_CONFIG="evaluation_data/tts_bot_configs/speechmatics_config.json"
OUTPUT="evaluation_output/small/speechmatics_speechmatics_results.json"
EVAL_OUTPUT="evaluation_output/small/speechmatics_speechmatics_evaluation.json"

echo "STT: Speechmatics"
echo "TTS: Speechmatics TTS"
echo ""
