...
# Run evaluation for AWS Transcribe (STT) + LMNT (TTS)

set -e

echo "=================================="
echo "AWS Transcribe + LMNT Evaluation"
echo "=================================="
...
TTS_CONFIG="evaluation_data/tts_bot_configs/lmnt_config.json"
OUTPUT="evaluation_output/small/aws_transcribe_lmnt_results.json"
EVAL_OUTPUT="evaluation_output/small/aws_transcribe_lmnt_evaluation.json"
