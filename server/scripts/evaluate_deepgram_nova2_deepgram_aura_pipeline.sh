...
# Run evaluation for Deepgram Nova 2 (STT) + Deepgram Aura (TTS)

set -e

echo "=================================="
echo "Deepgram Nova 2 + Deepgram Aura Evaluation"
echo "=================================="
...
STT_CONFIG="evaluation_data/stt_bot_configs/deepgram_nova2_config.json"
TTS_CONFIG="evaluation_data/tts_bot_configs/deepgram_aura_config.json"
OUTPUT="evaluation_output/small/deepgram_nova2_deepgram_aura_results.json"
EVAL_OUTPUT="evaluation_output/small/deepgram_nova2_deepgram_aura_evaluation.json"
